...
{
    public class DeveloperSourceViewModel : PackageSourceViewModel
    {
        public DeveloperSourceViewModel(DeveloperSource src) : base(src)
        {
            this.ManifestPath = src.ManifestPath;
        }
