...
public class InstalledPackages : NotifyPropertyChanged
{
    ...
    private async Task<ObservableCollection<SearchableInstallPackage>> GetInstalledApps()
    {
        ...
        {
            srcPackages = await this._application.CommandExecutor.Invoke<GetPackagesCommand, IList<PackageEntry>>(this, new GetPackagesCommand(PackageQuerySource.InstalledForCurrentUser())).ConfigureAwait(false);
        }
