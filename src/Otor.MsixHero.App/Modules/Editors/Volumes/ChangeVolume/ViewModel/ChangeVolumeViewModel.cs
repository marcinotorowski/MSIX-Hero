...
namespace Otor.MsixHero.App.Modules.Editors.Volumes.ChangeVolume.ViewModel
{
...
#pragma warning restore 4014
        ...
        public void CreateNew()
        {
            ...
            this.moduleManager.LoadModule(DialogModuleNames.Volumes);
            this.dialogService.ShowDialog(DialogPathNames.VolumesNewVolume, new DialogParameters(), async result =>
            {
