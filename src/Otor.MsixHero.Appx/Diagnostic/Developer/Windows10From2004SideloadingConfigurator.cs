...
public class Windows10From2004SideloadingConfigurator : BaseWindowsSideloadingConfigurator
{
    public override SideloadingFlavor Flavor => SideloadingFlavor.Windows10From2004;

    public override bool Set(SideloadingStatus status)
    {
        // On Windows 10 2004 and newer, sideloading is enabled by default.
