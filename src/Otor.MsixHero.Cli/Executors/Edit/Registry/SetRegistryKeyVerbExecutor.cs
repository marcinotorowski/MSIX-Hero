...
{
    public class SetRegistryKeyVerbExecutor : BaseEditVerbExecutor<SetRegistryKeyEditVerb>
    {
        public SetRegistryKeyVerbExecutor(string package, SetRegistryKeyEditVerb verb, IConsole console) : base(package, verb, console)
        {
        }
