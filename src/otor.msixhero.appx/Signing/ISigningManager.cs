...
namespace Otor.MsixHero.Appx.Signing
{
    public interface ISigningManager : ISelfElevationAware
    {
        ...
        Task SignPackageWithDeviceGuard(string package, Guid clientId, SecureString clientSecret, string timestampUrl = null, IncreaseVersionMethod increaseVersion = IncreaseVersionMethod.None, CancellationToken cancellationToken = default, IProgress<ProgressData> progress = null);
