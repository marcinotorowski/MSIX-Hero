...
namespace Otor.MsixHero.Appx.Common.Identity
{
    public class PackageIdentity
    {
        ...
        public string GetFamilyName() => AppName + "_" + PublisherHash;
        ...
        {
            return $"{AppName}_{AppVersion}_{Architecture:G}_{ResourceId}_{PublisherHash}";
        }
