    ...
    public static class PackageTypeConverter
    {
        public static string GetPackageTypeStringFrom(MsixApplicationType packageType, PackageTypeDisplay displayType = PackageTypeDisplay.Normal)
        {
            ...
            if (isUwp)
            {
                switch (displayType)
                {
                    case PackageTypeDisplay.Long:
                        return Common.Resources.Localization.Packages_Types_UWP_Long;
                    default:
                        return Common.Resources.Localization.Packages_Types_UWP;
                }
            }
            ...
            if (isBridge)
            {
                ...
                {
                    case PackageTypeDisplay.Long:
                        return Common.Resources.Localization.Packages_Types_W32_Long;
                    default:
                        return Common.Resources.Localization.Packages_Types_W32;
                }
            }
            ...
            if (isPsf)
            {
                ...
                {
                    case PackageTypeDisplay.Long:
                        return Common.Resources.Localization.Packages_Types_Psf_Long;
                    case PackageTypeDisplay.Short:
                        return Common.Resources.Localization.Packages_Types_Psf_Short;
                    default:
                        return Common.Resources.Localization.Packages_Types_Psf;
                }
            }
            ...
            if (isAiStub)
            {
                ...
                {
                    case PackageTypeDisplay.Long:
                        return Common.Resources.Localization.Packages_Types_AiStub_Long;
                    case PackageTypeDisplay.Short:
                        return Common.Resources.Localization.Packages_Types_AiStub_Short;
                    default:
                        return Common.Resources.Localization.Packages_Types_AiStub;
                }
            }
            ...
            if (isMsixHelper)
            {
                ...
                {
                    case PackageTypeDisplay.Long:
                        return Common.Resources.Localization.Packages_Types_MsixHelper_Long;
                    case PackageTypeDisplay.Short:
                        return Common.Resources.Localization.Packages_Types_MsixHelper_Short;
                    default:
                        return Common.Resources.Localization.Packages_Types_MsixHelper;
                }
            }
            ...
            if (isWeb)
            {
                ...
                {
                    case PackageTypeDisplay.Long:
                        return Common.Resources.Localization.Packages_Types_Pwa_Long;
                    default:
                        return Common.Resources.Localization.Packages_Types_Pwa;
                }
            }
            ...
            if (isFramework)
            {
                ...
                {
                    case PackageTypeDisplay.Short:
                        return Common.Resources.Localization.Packages_Types_Framework;
                    default:
                        return Common.Resources.Localization.Packages_Types_Framework;
                }
            }
            ...
            {
                case PackageTypeDisplay.Short:
                    return Common.Resources.Localization.Packages_Types_App;
                default:
                    return Common.Resources.Localization.Packages_Types_Unknown;
            }
        }
