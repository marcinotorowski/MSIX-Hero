...
namespace External.EricZimmerman.Registry.Abstractions
{
    ...
    public class RegistryKey
    {
        ...
        /// </summary>
        public string KeyName => this.NkRecord.Name;
        ...
        public string KeyPath
        {
            get
            {
                ...
                return $@"{this.Parent.KeyPath}\{this.KeyName}";
            }
        ...
        /// </summary>
        public DateTimeOffset? LastWriteTime => this.NkRecord.LastWriteTimestamp;
        ...
        public string GetRegFormat(HiveTypeEnum hiveType)
        {
            ...
            var keyNames = this.KeyPath.Split('\\');
            ...
            sb.AppendLine($";Last write timestamp {this.LastWriteTime.Value.UtcDateTime.ToString("o")}");
            ...
            foreach (var keyValue in this.Values)
            {
                ...
                switch (keyValue.VkRecord.DataType)
                {
                    ...
                    case VkCellRecord.DataTypeEnum.RegExpandSz:
                        ...
                        {
                            keyValueOut =
                                $"{prefix}{this.FormatBinaryValueData(keyValue.ValueDataRaw, keyNameOut.Length, prefix.Length)}";
                        }
                    ...
                    case VkCellRecord.DataTypeEnum.RegBinary:
                        ...
                        {
                            keyValueOut = $"hex:{this.FormatBinaryValueData(keyValue.ValueDataRaw, keyNameOut.Length, 5)}";
                        }
        ...
        public override string ToString()
        {
            ...
            sb.AppendLine($"Key Name: {this.KeyName}");
            sb.AppendLine($"Key Path: {this.KeyPath}");
            sb.AppendLine();

            sb.AppendLine($"Last Write Time: {this.LastWriteTime}");
            sb.AppendLine();

            // sb.AppendLine(string.Format("Is Deleted: {0}", IsDeleted));

            sb.AppendLine($"Key flags: {this.KeyFlags}");
...
//            sb.AppendLine();
            ...
            sb.AppendLine($"NK Record: {this.NkRecord}");

            sb.AppendLine();

            sb.AppendLine($"SubKey count: {this.SubKeys.Count:N0}");

            var i = 0;
            foreach (var sk in this.SubKeys)
            {
            ...
            sb.AppendLine($"Value count: {this.Values.Count:N0}");
