...
namespace otor.msixhero.lib.BusinessLayer.Executors.General
{
    internal class SetDefaultVolumeCommandExecutor : CommandExecutor
    {
        ...
        public SetDefaultVolumeCommandExecutor(SetDefaultVolume command, ISelfElevationManagerFactory<IAppxVolumeManager> volumeManager, IWritableApplicationStateManager stateManager) : base(command, stateManager)
        {
