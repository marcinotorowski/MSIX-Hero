...
{
    internal class RemoveVolumeServerExecutor : CommandExecutor
    {
        ...
        public RemoveVolumeServerExecutor(RemoveVolume command, ISelfElevationManagerFactory<IAppxVolumeManager> volumeManagerFactory, IWritableApplicationStateManager stateManager) : base(command, stateManager)
        {
